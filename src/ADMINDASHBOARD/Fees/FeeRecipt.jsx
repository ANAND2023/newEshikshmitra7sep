  ...
  return (
    <div>
      ...
      {/* <div className=" w-full  " ref={componentPDF}> */}
        <div className="grid  grid-cols-1 md:grid-cols-2 mx-auto  justify-around" ref={componentPDF}>
          <div className="pe-[5px] border-r border-dashed border-gray-800 p-1  rounded-sm dark:text-white">
            ...
            <div class="mt-1">
              <table class="w-full border border-gray-500 text-[12px]">
                <tbody>
                  <tr>
                    <td class="border border-gray-500 pl-2">Total Fee</td>
                    <td class="border border-gray-500 pl-2">.....</td>
                  </tr>

                  <tr>
                    <td class="border border-gray-500 pl-2">Paid Previous Dues</td>
                    <td class="border border-gray-500 pl-2">
                      {modalData.previousDues}
                    </td>
                  </tr>
                  <tr>
                    <td class="border border-gray-500 pl-2">Concession</td>
                    <td class="border border-gray-500 pl-2">....</td>
                  </tr>
                  <tr>
          ...
          <div className="pe-[5px] rounded-sm dark:text-white ps-1 p-1">
            <div className="flex justify-between ">
              <div className=" h-auto w-[150px]  dark:text-white  ">
                <img
                  className="h-12 w-12 rounded-full "
            ...
            <div class="mt-1">
              <table class="w-full border border-gray-500 text-[12px]">
                <tbody>
                  ...
                  <tr>
                    <td class="border border-gray-500 pl-2">Previous Dues</td>
                    <td class="border border-gray-500 pl-2">
                      {modalData.previousDues}
                    </td>
                  </tr>
