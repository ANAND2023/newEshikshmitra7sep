...
//     if (isOpen) {
//       // Reset the selectedChildren state when closing the modal
//       setSelectedChildren([]);
//     }
//   };
...
//         // regularFee: childFormData.classFee,
//         feeHistory: feeHistoryData,
//         remark: childFormData.remark || "", // Add this line
//         previousDues: parseFloat(childFormData.previousDues) || 0,
//         classFee: parseFloat(childFormData.classFee) || 0,
//         dues:
//           totalAmount -
//           (childFormData.additionalFeeValues?.reduce(
//             (sum, feeData) => sum + parseFloat(feeData.value || 0),
...
//   const calculateRegularFee = (index) => {
//     // const classFee = parseFloat(formData[index]?.classFee) || 0;
//     // const selectedMonths = formData[index]?.selectedMonths || [];
//     // return classFee * selectedMonths.length;
//   };
...
//                           <div className="md:mb-4">
//                             <label className="block ">
//                               Regular Fee: ₹{calculateRegularFee(index)}
//                             </label>
//                             {/* <input
//                               type="number"
//                               className="w-full border rounded-lg p-2 dark:bg-secondary-dark-bg dark:text-white"
