...
const Table = ({reLoad}) => {
  ...
  const currentItems = filteredFeeHistory.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  const paginatedData = filteredFeeHistory.slice(
  ...
  return (
    <div className="">
      ...
      {error && <p>{error}</p>}
        {feeHistory.length > 0 ? (<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
              ...
              {paginatedData
                ? paginatedData.map((fees, index) => (
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td className="px-6 py-4">{format(parseISO(fees.date), 'dd/MM/yyyy')}</td>
